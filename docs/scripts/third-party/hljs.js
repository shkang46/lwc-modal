var hljs = (function () {
    ...
    class i {
        ...
        static _walk(n, e) {
            return (
                "string" == typeof e
                    ? n.addText(e)
                    : e.children && (n.openNode(e), e.children.forEach((e) => this._walk(n, e)), n.closeNode(e)),
                n
            );
        }
        static _collapse(e) {
    ...
    function d(...e) {
        var n,
            t =
                "object" == typeof (n = (t = e)[t.length - 1]) && n.constructor === Object
    ...
    const N = {},
        ...
        A = (e, n) => {
            N[e + "/" + n] || (console.log(`Deprecated as of ${e}. ` + n), (N[e + "/" + n] = !0));
        },
        S = new Error();
    function M(e, n, { key: t }) {
        ...
        const r = {},
            s = {};
        for (let e = 1; e <= n.length; e++) (s[e + a] = i[e]), (r[e + a] = !0), (a += u(n[e - 1]));
        (e[t] = s), (e[t]._emit = r), (e[t]._multi = !0);
    }
    function q(e) {
        (n = e).scope && "object" == typeof n.scope && null !== n.scope && ((n.beginScope = n.scope), delete n.scope),
        ...
        if (Array.isArray(n.begin)) {
            if (n.skip || n.excludeBegin || n.returnBegin)
                throw (j("skip, excludeBegin, returnBegin not compatible with beginScope: {}"), S);
            if ("object" != typeof n.beginScope || null === n.beginScope) throw (j("beginScope must be object"), S);
            M(n, n.begin, { key: "beginScope" }), (n.begin = g(n.begin, { joinWith: "" }));
        }
        n = e;
        if (Array.isArray(n.end)) {
            if (n.skip || n.excludeEnd || n.returnEnd)
                throw (j("skip, excludeEnd, returnEnd not compatible with endScope: {}"), S);
            if ("object" != typeof n.endScope || null === n.endScope) throw (j("endScope must be object"), S);
            M(n, n.end, { key: "endScope" }), (n.end = g(n.end, { joinWith: "" }));
        }
    }
    function Q(r) {
        function s(e, n) {
            return new RegExp(c(e), "m" + (r.case_insensitive ? "i" : "") + (n ? "g" : ""));
        }
        class n {
            constructor() {
        ...
        class o {
            ...
            getMatcher(e) {
                ...
                const t = new n();
                return this.rules.slice(e).forEach(([e, n]) => t.addRule(e, n)), t.compile(), (this.multiRegexes[e] = t);
            }
    ...
    m = (function (a) {
        const O = Object.create(null),
            ...
            i = [];
        let S = !0;
        const M = "Could not find the language '{}', did you forget to load/include a language module?",
        ...
        function B(r, s, o, e) {
            ...
            function c() {
                if (m.keywords) {
                    let e = 0,
                        n = ((m.keywordPatternRe.lastIndex = 0), m.keywordPatternRe.exec(v)),
                        t = "";
                    for (; n; ) {
                        ...
                        if (i) {
                            ...
                            E.addText(t),
                                ...
                                (l[a] = (l[a] || 0) + 1),
                                l[a] <= 7 && (w += s),
                                r.startsWith("_") ? (t += n[0]) : ((i = p.classNameAliases[r] || r), E.addKeyword(n[0], i));
                        } else t += n[0];
                        (e = m.keywordPatternRe.lastIndex), (n = m.keywordPatternRe.exec(v));
                    }
                    ...
                    ? function () {
                          if ("" !== v) {
                              ...
                              if ("string" == typeof m.subLanguage) {
                                  ...
                                  (e = B(m.subLanguage, v, !0, f[m.subLanguage])), (f[m.subLanguage] = e._top);
                              } else e = T(v, m.subLanguage.length ? m.subLanguage : null);
                              0 < m.relevance && (w += e.relevance), E.addSublanguage(e._emitter, e.language);
                          }
                      }
                    : c)(),
                    (v = "");
            ...
            function u(e, n) {
                e.scope && "string" == typeof e.scope && E.openNode(p.classNameAliases[e.scope] || e.scope),
                    e.beginScope &&
                        (e.beginScope._wrap
                            ? (E.addKeyword(v, p.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap), (v = ""))
            ...
            function g(e) {
                ...
                for (const r of [a.__beforeBegin, a["on:begin"]])
                    if (r && (r(e, i), i.isMatchIgnored))
                        return (n = t), 0 === m.matcher.regexIndex ? ((v += n[0]), 1) : ((N = !0), 0);
                return (
                    a.skip ? (v += t) : (a.excludeBegin && (v += t), d(), a.returnBegin || a.excludeBegin || (v = t)),
                    u(a, e),
            ...
            function b(e) {
                var n = e[0],
                    ...
                    a = (function e(n, t, a) {
                        ...
                        var r, s;
                        if (i && (n["on:end"] && ((s = new D(n)), n["on:end"](t, s), s.isMatchIgnored && (i = !1)), i)) {
                ...
                for (
                    m.endScope && m.endScope._wrap
                        ...
                        : t.skip
                        ? (v += n)
                        : (t.returnEnd || t.excludeEnd || (v += n), d(), t.excludeEnd && (v = n));
            ...
            function n(e, n) {
                ...
                if ("begin" === h.type && "end" === n.type && h.index === n.index && "" === t) {
                ...
                if ("illegal" === n.type && !o) {
                    const i = new Error('Illegal lexeme "' + t + '" for mode "' + (m.scope || "<unnamed>") + '"');
                    throw ((i.mode = m), i);
                }
                if ("end" === n.type) {
                    e = b(n);
                ...
                if (1e5 < _ && _ > 3 * n.index) throw new Error("potential infinite loop, way more iterations than matches");
                return (v += t), t.length;
            }
            const p = I(r);
            if (!p) throw (j(M.replace("{}", r)), new Error('Unknown language: "' + r + '"'));
            var t = Q(p);
            let a = "",
                m = e || t;
            const f = {},
            ...
            try {
                for (m.matcher.considerAll(); ; ) {
                    _++, N ? (N = !1) : m.matcher.considerAll(), (m.matcher.lastIndex = y);
                ...
                return (
                    ...
                    E.finalize(),
                    (a = E.toHTML()),
                    { language: r, value: a, relevance: w, illegal: !1, _emitter: E, _top: m }
                );
            } catch (e) {
                ...
                if (S) return { language: r, value: C(s), illegal: !1, relevance: 0, errorRaised: e, _emitter: E, _top: m };
                throw e;
            }
        }
        function T(n, e) {
            ...
            var t = (function (e) {
                const n = { value: C(e), illegal: !1, relevance: 0, _top: s, _emitter: new R.__emitter(R) };
        ...
        function n(e) {
            var n,
                ...
                i = (function (e) {
                    ...
                    return a
                        ? ((t = I(a[1])) ||
                              (x(M.replace("{}", a[1])), x("Falling back to no-highlight mode for this block.", e)),
                          t ? a[1] : "no-highlight")
            ...
            o(i) ||
                ...
                (e.result = { language: n.language, re: n.relevance, relevance: n.relevance }),
                n.secondBest && (e.secondBest = { language: n.secondBest.language, relevance: n.secondBest.relevance }));
        }
        let t = !1;
        function e() {
        ...
        "undefined" != typeof window &&
            ...
            Object.assign(a, {
                ...
                initHighlighting: () => {
                    e(), A("10.6.0", "initHighlighting() deprecated.  Use highlightAll() now.");
                },
                initHighlightingOnLoad: function () {
                    e(), A("10.6.0", "initHighlightingOnLoad() deprecated.  Use highlightAll() now.");
                },
                registerLanguage: function (n, e) {
                    ...
                    try {
                        ...
                        if ((j("Language definition for '{}' could not be registered.".replace("{}", n)), !S)) throw e;
                        j(e), (t = s);
                    }
                    t.name || (t.name = n),
    ...
    const R = "[A-Za-z$_][0-9A-Za-z$_]*",
        ...
        se = ["EvalError", "InternalError", "RangeError", "ReferenceError", "SyntaxError", "TypeError", "URIError"],
        oe = [
            "setInterval",
            "setTimeout",
            "clearInterval",
        ...
        le = ["arguments", "this", "super", "console", "window", "document", "localStorage", "module", "global"],
        ce = [].concat(oe, re, se);
    function de(e) {
        var n = R;
        const t = "<>",
        ...
        var o = { $pattern: R, keyword: ae, literal: ie, built_in: ce, "variable.language": le },
            l = "[0-9](_?[0-9])*",
            c = `\\.(${l})`,
        ...
        const u = { className: "subst", begin: "\\$\\{", end: "\\}", keywords: o, contains: [] };
        var d = {
                begin: "html`",
                end: "",
            ...
            g = { className: "string", begin: "`", end: "`", contains: [e.BACKSLASH_ESCAPE, u] },
            b = {
                className: "comment",
                variants: [
                    e.COMMENT(/\/\*\*(?!\/)/, "\\*/", {
        ...
        const h = [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, d, c, g, l, e.REGEXP_MODE],
            p =
                ((u.contains = h.concat({ begin: /\{/, end: /\}/, keywords: o, contains: ["self"].concat(h) })),
                [].concat(b, u.contains));
        var m = p.concat([{ begin: /\(/, end: /\)/, keywords: o, contains: ["self"].concat(p) }]),
            f = { className: "params", begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: o, contains: m },
            E = {
                variants: [
        ...
        return {
            ...
            contains: [
                ...
                { beginKeywords: "while if switch catch for" },
                {
                    ...
                    returnBegin: !0,
                    label: "func.def",
                    contains: [f, e.inherit(e.TITLE_MODE, { begin: n, className: "title.function" })]
                },
                { match: /\.\.\./, relevance: 0 },
                _,
                { match: "\\$" + n, relevance: 0 },
    ...
    function ue(e) {
        ...
        return {
            ...
            contains: [
                ...
                { className: "selector-tag", begin: "\\b(" + V.join("|") + ")\\b", relevance: 0 },
                ...
                },
                {
                    ...
                    contains: [r, n.HEXCOLOR, n.CSS_NUMBER_MODE, e.QUOTE_STRING_MODE, e.APOS_STRING_MODE, n.IMPORTANT]
                },
                { begin: "@(page|font-face)", keywords: { $pattern: i, keyword: "@page @font-face" } },
                {
                    ...
                    returnBegin: !0,
                    keywords: { $pattern: /[a-z-]+/, keyword: "and or not only", attribute: Y.join(" ") },
                    contains: [
    ...
    (f = (e) => O(/\b/, e, /\w$/.test(e) ? /\b/ : /\B/)),
        ...
        (w = d(v, /\d/, /[\u0300-\u036F\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F]/)),
        (o = O(v, w, "*"));
    O(/[A-Z]/, w, "*"), O(/convention\(/, d("swift", "block", "c"), /\)/), O(/objc\(/, o, /\)/);
    var ge = Object.freeze({
        ...
        grmr_bash: function (e) {
            ...
            Object.assign(n, {
                className: "variable",
                variants: [{ begin: O(/\$[\w\d#@][\w\d_]*/, "(?![\\w\\d])(?![$])") }, t]
            });
        ...
        grmr_xml: function (e) {
            var n = O(/[A-Z_]/, O("(?:", /[A-Z0-9_.-]*:/, ")?"), /[A-Z0-9_.-]*/),
        ...
        grmr_markdown: function (e) {
            var n = { begin: /<\/?[A-Za-z_]/, end: ">", subLanguage: "xml", relevance: 0 },
                t = {
                    variants: [
                        { begin: /\[.+?\]\[.*?\]/, relevance: 0 },
                        { begin: /\[.+?\]\(((data|javascript|mailto):|(?:http|ftp)s?:\/\/).*?\)/, relevance: 2 },
                        { begin: O(/\[.+?\]\(/, /[A-Za-z][A-Za-z0-9+.-]*/, /:\/\/.*?\)/), relevance: 2 },
                        { begin: /\[.+?\]\([./?&#].*?\)/, relevance: 1 },
                        { begin: /\[.+?\]\(.*?\)/, relevance: 0 }
                    ],
                    returnBegin: !0,
            ...
            var s = {
                ...
                o = { className: "quote", begin: "^>\\s+", contains: r, end: "$" };
            return {
                name: "Markdown",
        ...
        grmr_typescript: function (e) {
            ...
            var n = {
                    ...
                    literal: ie,
                    built_in: ce.concat(["any", "void", "number", "boolean", "string", "object", "never", "enum"]),
            ...
            return (r.relevance = 0), Object.assign(i, { name: "TypeScript", aliases: ["ts", "tsx"] }), i;
        },
        grmr_yaml: function (e) {
            ...
            const r = { end: ",", endsWithParent: !0, excludeEnd: !0, keywords: n, relevance: 0 };
            var s = { begin: /\{/, end: /\}/, contains: [r], illegal: "\\n", relevance: 0 },
            ...
            return (
                l.pop(), l.push(i), (r.contains = l), { name: "YAML", case_insensitive: !0, aliases: ["yml"], contains: t }
            );
        }
    });
    const be = m;
