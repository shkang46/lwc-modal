    ...
    */
    ...
    var NUMERIC = {
        ...
        variants: [
            ...
            {
                begin:
                    `\\b0[xX]((${hexDigits})\\.?|(${hexDigits})?\\.(${hexDigits}))` + `[pP][+-]?(${decimalDigits})[fFdD]?\\b`
            },
    ...
    function javascript(hljs) {
        ...
        const CLASS_OR_EXTENDS = {
            variants: [
                ...
                {
                    match: [/extends/, /\s+/, concat(IDENT_RE$1, "(", concat(/\./, IDENT_RE$1), ")*")],
                    scope: {
                        1: "keyword",
        ...
        const FUNCTION_CALL = {
            match: concat(/\b/, noneOf([...BUILT_IN_GLOBALS, "super"]), IDENT_RE$1, lookahead(/\(/)),
        ...
        const FUNCTION_VARIABLE = {
            match: [/const|var|let/, /\s+/, IDENT_RE$1, /\s*/, /=\s*/, lookahead(FUNC_LEAD_IN_RE)],
            className: {
                1: "keyword",
                3: "title.function"
            },
        ...
        return {
            ...
            contains: [
                ...
                },
                {
                    ...
                    returnBegin: true,
                    label: "func.def",
                    contains: [PARAMS, hljs.inherit(hljs.TITLE_MODE, { begin: IDENT_RE$1, className: "title.function" })]
                },
