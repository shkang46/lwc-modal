!(function (r, o) {
    ...
    function t(e) {
        ...
        var a,
            i = t.textContent,
            l = r.textContent;
        for (o < e && ((a = e), (e = o), (o = a), (a = i), (i = l), (l = a)); 0 !== n.indexOf(i); ) i = i.slice(1);
    ...
    function a(e) {
        try {
            ...
            for (n in t) !t.hasOwnProperty(n) || t[n].classList.contains("nohljsln") || i(t[n], e);
        } catch (e) {
        ...
        var n = {
            ...
            e =
                (!(function e(n) {
                    ...
                    for (var r in t)
                        !t.hasOwnProperty(r) ||
                            (0 < p((r = t[r]).textContent) && (0 < r.childNodes.length ? e(r) : m(r.parentNode)));
                })(e),
                e.innerHTML),
            t = n,
            r = g(e);
        if (("" === r[r.length - 1].trim() && r.pop(), 1 < r.length || t.singleLine)) {
            for (var o = "", a = 0, i = r.length; a < i; a++)
                o += v('<tr><td class="{0} {1}" {3}="{5}"></td><td class="{0} {4}" {3}="{5}">{6}</td></tr>', [
                    s,
                    c,
                    u,
                    h,
    ...
    r.hljs
        ? ((r.hljs.initLineNumbersOnLoad = function (e) {
          ...
          (r.hljs.lineNumbersValue = function (e, n) {
              var t;
              if ("string" == typeof e) return ((t = document.createElement("code")).innerHTML = e), d(t, n);
          }),
          ((e = o.createElement("style")).type = "text/css"),
          (e.innerHTML = v(".{0}{border-collapse:collapse}.{0} td{padding:0}.{1}:before{content:attr({2})}", [l, u, h])),
        ...
        document.addEventListener("copy", function (e) {
            ...
            !(function (e) {
                ...
                ((n = -1 !== window.navigator.userAgent.indexOf("Edge") ? t(n) : n.toString()),
