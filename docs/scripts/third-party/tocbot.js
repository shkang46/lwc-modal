                                    ...
                                    i.skipRendering || t.render(i.tocSelector, m),
                                        (this._scrollListener = f(function (e) {
                                            ...
                                            ((e && (0 === e.eventPhase || null === e.currentTarget)) || n) &&
                                                (t.updateToc(l), i.scrollEndCallback && i.scrollEndCallback(e));
                                        }, i.throttleTimeout)),
                ...
                var l = o.appendChild(
                    (function (n) {
                        ...
                        return (
                            ...
                            l.setAttribute("class", e.linkClass + r + "node-name--" + n.nodeName + r + e.extraLinkClasses),
                            o.appendChild(l),
                            o
                        );
                    })(n)
                        ...
                        e.positionFixedSelector &&
                            (function () {
                                ...
                                "auto" === e.fixedSidebarOffset &&
                                    (e.fixedSidebarOffset = document.querySelector(e.tocSelector).offsetTop),
                                    t > e.fixedSidebarOffset
                                        ? -1 === n.className.indexOf(e.positionFixedClass) &&
                                          (n.className += r + e.positionFixedClass)
                                        : (n.className = n.className.split(r + e.positionFixedClass).join(""));
                            })();
                    var c,
                        a = i;
                    if (l && null !== document.querySelector(e.tocSelector) && a.length > 0) {
                        n.call(a, function (t, n) {
                            return (function t(n) {
                                var o = 0;
                                return (
                                    n !== document.querySelector(e.contentSelector && null != n) &&
                                        ((o = n.offsetTop), e.hasInnerContainers && (o += t(n.offsetParent))),
                                    o
                                );
                            })(t) >
                        ...
                        t.call(h, function (t) {
                            ...
                            f.nextSibling &&
                                ...
                                (f.nextSibling.className = f.nextSibling.className.split(r + e.isCollapsedClass).join("")),
                            (function t(n) {
                                return -1 !== n.className.indexOf(e.collapsibleClass) &&
                                    -1 !== n.className.indexOf(e.isCollapsedClass)
                                    ? ((n.className = n.className.split(r + e.isCollapsedClass).join("")),
                                ...
                                r &&
                                    (function (t, l) {
                                        for (
                                            ...
                                            (c = n(s)) && void 0 !== c.children && (s = c.children), a--;
